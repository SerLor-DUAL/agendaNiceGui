...
from backend.api.dependencies import auth_guard
...
fastapi_app.include_router(users.router)            # Users API
fastapi_app.include_router(auth_guard.router)       # Authentication API
